...
export default function CardComida(props) {
  ...
  return(
    <Link to={{pathname: '/carrinho', state: props}} className='flex flex-col rounded-xl shadow-md border w-20vw  justify-start items-start '>
      ...
      <div className='flex flex-col gap-2 p-3'>
        ...
        <button className='border w-48 h-9 text-white bg-sky-600 rounded-lg' onClick={salvarItem}>Adicionar ao pedido</button>
      </div>
    </Link>
  )
}