...
export default function LoginAtendente() {
  return(
    <div className=" bg-white flex justify-center items-center h-screen">
      <div className="shadow-2xl rounded-3xl bg-gray-300 w-30vw items-center flex flex-col p-14">
      <h1 className=" text-3xl font-semibold">PizzaDelivery - Login</h1>
      <h3 className="text-2xl">Atendente</h3>

      <form className="flex flex-col items-start w-full gap-y-6" action="">
        <label className="flex flex-col w-full" htmlFor="login">
          Login:
          <input className="outline-none bg-white rounded-md w-full h-8" id="login" type="text" />
        </label>
        <label className="flex flex-col w-full" htmlFor="senha">
          Senha:
          <input className="outline-none bg-white rounded-md w-full h-8" id="senha" type="password" />
        </label>
