    ...
    return (
        <div className="flex flex-col items-center justify-center py-7 bg-gray-100 h-screen">
            ...
            <div>
                ...
                <table className="flex flex-col shadow-xl rounded-2xl bg-white py-6 gap-3 h-midVh overflow-y-scroll">
                    <thead className="">
                        <tr className="flex flex-row justify-evenly items-center">
                            <th className="w-52">ID</th>
                            <th className="w-52">Status</th>
                            <th className="w-52">Cliente</th>
                            <th className="w-52">Atendente</th>
